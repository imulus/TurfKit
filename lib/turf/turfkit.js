  ...
  return this.Filter = (function() {
    ...
    Filter.prototype.change = function(callback) {
      return this.$select.change(__bind(function() {
        var include, key, marker, results, value, _i, _len, _ref, _ref2;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          for (key in _ref2) {
            ...
            if (marker.properties[key] !== value) {
              include = false;
            }
          }
          if (include) {
    ...
    Filter.prototype.reset = function() {
      this.values = {};
      this.$select.empty();
      return this.$select.append("<option value='all'>All</option>");
    };
    return Filter;
  })();
});
