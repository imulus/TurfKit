...
var ResultsTable;
module('Turf');
Turf.ResultsTable = ResultsTable = (function() {
...
var InfoWindow;
module('Turf');
Turf.InfoWindow = InfoWindow = (function() {
  InfoWindow.windows = [];
...
var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
module('Turf');
Turf.Marker = Marker = (function() {
  function Marker(map, params) {
    var shadow;
    this.map = map;
    this.hidden = false;
    this.id = params.id;
    this.center = new Turf.Point(params.lat, params.lng);
    this.infoWindow = null;
    this.color = params.color || '#D23';
  ...
  Marker.prototype.setInfoWindow = function(params) {
    this.infoWindow = new Turf.InfoWindow(this.map, this.marker, params);
    return this.observe();
  };
  return Marker;
})();
...
var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
module('Turf');
Turf.Application = Application = (function() {
  function Application(wrapper_id, data) {
  ...
  Application.prototype.build = function() {
    var filter, json, point, _filter, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3, _results;
    json = this.data;
    this.map = new Turf.Map("map", json.map);
    this.results = new Turf.ResultsTable($('#results'), json);
    this.results.reset();
